# Generated by Django 4.2 on 2024-03-26 20:13
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('model_group', models.CharField(max_length=10, unique=True)),
            ],
        ),
        migrations.CreateModel(
            name='ProductSeason',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('age', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='products.productage')),
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='products.productcategory')),
                ('gender', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='products.productgender')),
                ('model_group', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='products.productmodelgroup', to_field='model_group')),
                ('product_type', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='products.producttype')),
                ('season', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='products.productseason')),
